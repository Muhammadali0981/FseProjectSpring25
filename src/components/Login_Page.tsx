...
const Login = () => {
  return (
    <div className="rounded-lg shadow-lg bg-blue-300 w-screen h-screen flex flex-col justify-center items-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6">
        {/* Student Login Box */}
        <div className="p-6 bg-blue-700 rounded-lg shadow-lg w-60 text-center">
