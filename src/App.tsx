...
const App = () => {
  return (
    <Router>
      {/* Navigation Bar */}
      <div className="fixed top-0 w-full p-4 bg-blue-400 text-white shadow-lg flex justify-between">
      ...
      <Routes>
        ...
        <Route
          path="/"
          element={
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white pt-16">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-6 w-360">
                {/* Library Box */}
                <div className="p-6 bg-blue-600 rounded-lg shadow-lg w-60 text-center">
